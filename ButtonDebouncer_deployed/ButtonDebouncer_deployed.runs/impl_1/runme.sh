...
HD_PWD='C:/Users/garwo/FPGAProjects/ButtonDebounce/ButtonDebouncer_deployed/ButtonDebouncer_deployed.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_board.tcl -notrace
