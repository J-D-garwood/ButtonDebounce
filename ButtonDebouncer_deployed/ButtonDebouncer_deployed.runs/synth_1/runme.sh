...
HD_PWD='C:/Users/garwo/FPGAProjects/ButtonDebounce/ButtonDebouncer_deployed/ButtonDebouncer_deployed.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_board.tcl
